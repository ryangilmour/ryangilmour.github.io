...
> I expect if you are here, I have likely already spoken to you a bit about effective giving. Either way, I feel like I should expand on _why_ this is important to me.
...
I also think that it is right to focus on global poverty, because the problems there are large in scale and are solvable. 
The facts around death resulting from preventable diseases are alarming and depressing when we live in a world with such abundant resources. 
However, the problem is not unsurmountable, and progress is being made (e.g., [eradication of smallpox](https://www.who.int/news-room/spotlight/history-of-vaccination/history-of-smallpox-vaccination) and [the reduction in global child mortality](https://www.who.int/data/gho/data/themes/topics/topic-details/GHO/child-mortality-and-causes-of-death)). 
...
1. Donate (3 minutes)
2. Log that you donated via the form (1 minute)  

## Step 1 - Donate

1. Go to the Effective Altruism NZ donations page: [https://effectivealtruism.nz/donate/global-health-and-development](https://effectivealtruism.nz/donate/global-health-and-development)
2. Take your pick of charity. 
...
_Ultimately this process is anonymous for ease and to avoid people having to share details. That said, if you have made a donation and **want to let me know directly** - ping me a message. I would personally find that inspiring and motivating, but no pressure._ 
...
- **How do I know my donation has been useful?**
   ...
   - One well respected organisation is [GiveWell](https://www.givewell.org/). 
     - GiveWell charities are those that are supported by EA NZ. 
   - Effective Altruism NZ also focus on the principles of [cost-effectiveness and cause prioritisation](https://effectivealtruism.nz/cause-prioritisation), focusing on problems that are:
     - Large in scale
     - Neglected
     - Tractably solvable
